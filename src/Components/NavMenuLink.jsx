...
const NavMenuButton = ({ link, name }) => {
  return (
    <li className="group relative inline-flex h-12 w-full items-center justify-start overflow-hidden bg-white py-1.5 pl-13 font-medium transition-all hover:bg-white max-md:pl-7">
      <Link to={link}>
